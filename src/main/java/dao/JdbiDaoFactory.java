...
public class JdbiDaoFactory {
    ...
    private static final String DB_USERNAME = "watch";
    private static final String DB_PASSWORD = "watch";

    private static String jdbcUri = "jdbc:h2:tcp://localhost/watch_store";
