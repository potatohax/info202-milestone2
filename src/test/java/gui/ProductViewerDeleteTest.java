...
public class ProductViewerDeleteTest {
    ...
    public void testDelete() {
        ...
        //verify that p1 is deleted
        verify(dao).removeProduct(p1);
        
        //check that the JList contains 2 products left
        ...
        //check that the deleted product p1 is not in the jlist
        assertThat(model, not(containsInAnyOrder(p1)));
